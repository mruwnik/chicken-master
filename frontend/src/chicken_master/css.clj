     ...
     [:.day {:border "2px solid black"
      ...
      [:.orders {:padding-left "25px"}
       ...
       [:.order.fulfilled {:color "rgb(114, 114, 114)"}
        [:.who {:text-decoration :line-through}]]
       ...
       [:.who {:font-size "18px"
        ...
        [:.pickup-check {:width "18px"
                         :height "18px"
                         :margin-right "8px"
                         :vertical-align :middle
                         :cursor :pointer
                         :accent-color "rgb(30, 90, 40)"}]]]
      [[:.products :.products-sum] {:padding-left "25px"}
       [:.product {:margin-bottom "5px"}
        ...
        [:.product-price {:width "40px"
                          :max-height "5px"}]
        [:.product-stock {:color "rgb(150, 150, 150)"
                          :margin-left "4px"}]]
       [:.product.over-capacity {:color "rgb(192, 50, 50)"
                                 :font-weight :bold}
        [:.product-stock {:color "rgb(192, 50, 50)"}]]]
      [:.summary {:margin-top "10px"}
       [:.day-seperator {:margin-right "25px"}]]]]
